...
class AgentCoordinator:
    def __init__(self, test_dir="/home/edwin/GolandProjects/PersonalClaude/agent-reliability-tests/hello-world-again"):
...
1. Write "hello" to /home/edwin/GolandProjects/PersonalClaude/agent-reliability-tests/hello-world-again/message_to_fullstack.txt
2. Append "python-pro: hello" to /home/edwin/GolandProjects/PersonalClaude/agent-reliability-tests/hello-world-again/chat.log  
3. Wait for and read response from /home/edwin/GolandProjects/PersonalClaude/agent-reliability-tests/hello-world-again/message_to_python.txt
...
"""
        ...
        try:
            ...
            process = subprocess.Popen(cmd, cwd=self.test_dir, stdout=subprocess.PIPE, stderr=subprocess.PIPE, universal_newlines=True)
            return process
        except Exception as e:
...
EXACT STEPS TO FOLLOW:
1. Read the message from /home/edwin/GolandProjects/PersonalClaude/agent-reliability-tests/hello-world-again/message_to_fullstack.txt
2. Write "world" to /home/edwin/GolandProjects/PersonalClaude/agent-reliability-tests/hello-world-again/message_to_python.txt
3. Append "fullstack-developer: world" to /home/edwin/GolandProjects/PersonalClaude/agent-reliability-tests/hello-world-again/chat.log
4. Signal completion
